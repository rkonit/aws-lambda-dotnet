...
namespace Amazon.Lambda.LexV2Events
{
    ...
    public class LexV2Transcription
    {
        ...
        /// </summary>
        public LexV2TranscriptionConfidenceScore TranscriptionConfidence { get; set; }
        ...
        /// <summary>
        /// The class that represents a Transcription Confidence Score.
        /// </summary>
        public class LexV2TranscriptionConfidenceScore
        {
            /// <summary>
            /// A score to help determine if the transcription is the correct one. 
